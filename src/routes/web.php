...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('employees', [EmployeeController::class, 'show'])->middleware(checkRole::class);
    Route::get('employees/{id}', [EmployeeController::class, 'getEmployee'])->middleware(checkRole::class);
    ...
    Route::get('services', [ServiceController::class, 'show'])->middleware(checkRole::class);
